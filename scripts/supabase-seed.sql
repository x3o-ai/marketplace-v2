-- Trinity Agent Marketplace - Production Seed Data for Supabase
-- Run this after supabase-setup.sql to populate Trinity Agents and initial data

-- Insert Trinity AI Agents
INSERT INTO "ai_agents" ("id", "name", "slug", "description", "model", "version", "config", "prompts", "capabilities", "tier", "status") VALUES
(
    ...
    ARRAY['Revenue Forecasting', 'Customer Analytics', 'Market Trend Analysis', 'Risk Assessment', 'Performance Optimization', 'ROI Calculation', 'Predictive Modeling', 'Business Intelligence']::TEXT[],
    'ENTERPRISE'::AgentTier,
    'ACTIVE'::AgentStatus
),
(
    ...
    ARRAY['System Health Monitoring', 'Performance Optimization', 'Anomaly Detection', 'Security Analysis', 'Resource Management', 'Uptime Monitoring', 'Alert Management', 'Auto-scaling']::TEXT[],
    'ENTERPRISE'::AgentTier,
    'ACTIVE'::AgentStatus
),
(
    ...
    ARRAY['Content Generation', 'Campaign Optimization', 'Brand Consistency', 'Process Automation', 'Workflow Enhancement', 'A/B Testing', 'Performance Analysis', 'Creative Strategy']::TEXT[],
    'ENTERPRISE'::AgentTier,
    'ACTIVE'::AgentStatus
);
...
-- Create demo organization for testing in production
INSERT INTO "organizations" ("id", "name", "domain", "industry", "size", "subscription", "billingEmail", "settings", "integrationConfig") VALUES
(
    'demo-org-x3o-prod',
...
INSERT INTO "users" ("id", "name", "email", "role", "status", "organizationId", "department", "jobTitle", "permissions") VALUES
(
    'demo-user-x3o-prod',
    'Trinity Demo User',
    'demo@x3o.ai',
    ...
    'Operations',
    'Operations Manager',
    ARRAY['trinity_agent_trial', 'analytics_access', 'dashboard_full']::TEXT[]
);

-- Create sample AI interactions for demo
INSERT INTO "ai_interactions" ("userId", "organizationId", "agentId", "query", "response", "confidence", "processingTime", "category", "tags", "status") VALUES
(
    'demo-user-x3o-prod',
    'demo-org-x3o-prod',
    'oracle-agent-prod-001',
    ...
    ARRAY['revenue', 'forecasting', 'quarterly']::TEXT[],
    'COMPLETED'::InteractionStatus
),
(
    'demo-user-x3o-prod',
    'demo-org-x3o-prod',
    ...
    340,
    'system_monitoring',
    ARRAY['performance', 'optimization', 'monitoring']::TEXT[],
    'COMPLETED'::InteractionStatus
),
(
    'demo-user-x3o-prod',
    ...
    2100,
    'content_generation',
    ARRAY['email', 'campaign', 'product-launch']::TEXT[],
    'COMPLETED'::InteractionStatus
);
