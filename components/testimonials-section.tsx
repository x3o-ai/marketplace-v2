  ...
  const testimonials = [
    {
      ...
      company: "Chief Data Officer, Global Healthcare Systems",
      image:
    ...
    {
      quote:
        "Oracle Agent automated our entire business intelligence operation. We went from 20 analysts to 2 supervisors with 10x better insights and zero human error.",
      name: "Michael Thompson",
      company: "VP of Operations, Fortune 500 Manufacturing",
      image:
    ...
    {
      quote:
        "Sentinel Agent's autonomous monitoring saved us $2.3M annually in operational costs while eliminating 99.9% of system downtime incidents.",
      name: "Sarah Chen-Williams",
      company: "CTO, Enterprise Technology Solutions",
      image:
